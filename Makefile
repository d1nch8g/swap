...
gen:
	...
	swag init -o . --ot yaml
	npm run build
	go-bindata -fs -nometadata -pkg web -o gen/web/web.go  -prefix "dist/" dist/...
	go-bindata -fs -nometadata -pkg migr -o gen/migr/migr.go  -prefix "db/migrations/" db/migrations/...
